...
namespace Stationnement.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CategoryID,ParentCategoryID,Name,rowguid,ModifiedDate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CategoryID,ParentCategoryID,Name,rowguid,ModifiedDate")] Category category)
        {
            if (ModelState.IsValid)
            {
